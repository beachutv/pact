  ...
  return (
    <div id="app-shell" style={{ justifyContent: 'center', padding: '0 24px' }}>
      <div style={{ maxWidth: 340, width: '100%', margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--text2)', textAlign: 'center', marginTop: 10, lineHeight: 1.5 }}>
          Sign in with the Google account linked to your Google Calendar so Pact can read your availability.
        </p>

        {error && (
          <p style={{ marginTop: 12, fontSize: 13, color: 'var(--red)', textAlign: 'center' }}>
            {error}
          </p>
        )}
      </div>
